...
class FileDataTransfer_Gtest : public GTestWithTmpDir {
protected:
    ...
    bool open_file_data_transfer(uint32_t raw_events_per_read = raw_events_per_read_default_,
        ...
        file_data_transfer_.reset(new FileDataTransfer(std::move(ifs), raw_event_size_bytes_, config));
...
protected:
    std::unique_ptr<FileDataTransfer> file_data_transfer_;
...
constexpr uint32_t FileDataTransfer_Gtest::raw_event_size_bytes_;
constexpr uint32_t FileDataTransfer_Gtest::read_buffers_count_;
constexpr uint32_t FileDataTransfer_Gtest::bytes_per_written_buffer_default_;
constexpr uint32_t FileDataTransfer_Gtest::n_buffers_default_;
constexpr uint32_t FileDataTransfer_Gtest::raw_events_per_read_default_;

TEST_F(FileDataTransfer_Gtest, file_does_not_exists) {
    ////////////////////////////////////////////////////////////////////////////////
    // PURPOSE
...
TEST_F(FileDataTransfer_Gtest, reading_integrity) {
...
TEST_F(FileDataTransfer_Gtest, memory_usage) {
    // GIVEN a RAW file with known content
    auto data_ref = write_ref_data();
...
TEST_F(FileDataTransfer_Gtest, invalid_parameters) {
    // GIVEN a RAW file with known content
    auto data_ref = write_ref_data();
