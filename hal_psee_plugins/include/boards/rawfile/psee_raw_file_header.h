...
public:
    PseeRawFileHeader(const I_HW_Identification &, const I_Geometry &);
    ...
    std::unique_ptr<Metavision::I_Geometry> get_geometry() const;
...
private:
    ...
    void set_geometry(const Metavision::I_Geometry &);
};
