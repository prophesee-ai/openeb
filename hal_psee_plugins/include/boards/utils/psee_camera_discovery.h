...
#ifndef METAVISION_HAL_PSEE_CAMERA_DISCOVERY_H
#define METAVISION_HAL_PSEE_CAMERA_DISCOVERY_H
...
class PseeCameraDiscovery : public CameraDiscovery {
public:
...
#endif // METAVISION_HAL_PSEE_CAMERA_DISCOVERY_H
