...
#ifndef METAVISION_HAL_GEN41_REGISTERMAP_H
#define METAVISION_HAL_GEN41_REGISTERMAP_H

#include "metavision/psee_hw_layer/utils/regmap_data.h"

static RegmapElement Gen41RegisterMap[] = {
    // clang-format off
...
static uint32_t Gen41RegisterMapSize = sizeof(Gen41RegisterMap) / sizeof(Gen41RegisterMap[0]);

#endif // METAVISION_HAL_GEN41_REGISTERMAP_H
