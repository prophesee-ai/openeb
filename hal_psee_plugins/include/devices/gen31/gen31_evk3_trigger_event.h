...
#ifndef METAVISION_HAL_GEN31_EVK3_TRIGGER_EVENT_H
#define METAVISION_HAL_GEN31_EVK3_TRIGGER_EVENT_H
...
class Gen31Evk3TriggerEvent : public PseeTriggerIn {
public:
    /// @brief Constructor
    Gen31Evk3TriggerEvent(const std::shared_ptr<RegisterMap> &register_map,
...
#endif // METAVISION_HAL_GEN31_TRIGGER_EVENT_H
