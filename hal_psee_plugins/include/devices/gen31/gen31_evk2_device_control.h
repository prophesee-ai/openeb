...
#ifndef METAVISION_HAL_CCAM_GEN31_EVK2_DEVICE_CONTROL_H
#define METAVISION_HAL_CCAM_GEN31_EVK2_DEVICE_CONTROL_H
...
class Gen31Evk2DeviceControl : public PseeDeviceControl {
public:
    Gen31Evk2DeviceControl(const std::shared_ptr<RegisterMap> &register_map);
    ~Gen31Evk2DeviceControl();
...
#endif // METAVISION_HAL_CCAM_GEN31_EVK2_DEVICE_CONTROL_H
