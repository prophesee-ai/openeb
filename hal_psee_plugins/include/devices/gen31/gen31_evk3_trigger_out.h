...
#ifndef METAVISION_HAL_GEN31_EVK3_TRIGGER_OUT_H
#define METAVISION_HAL_GEN31_EVK3_TRIGGER_OUT_H
...
class Gen31Evk3TriggerOut : public PseeTriggerOut {
public:
    Gen31Evk3TriggerOut(const std::shared_ptr<RegisterMap> &regmap,
...
#endif // METAVISION_HAL_GEN31_EVK3_TRIGGER_OUT_H
