...
#ifndef METAVISION_HAL_GEN31_TRIGGER_EVENT_H
#define METAVISION_HAL_GEN31_TRIGGER_EVENT_H
...
class Gen31TriggerEvent : public PseeTriggerIn {
public:
    /// @brief Constructor
    Gen31TriggerEvent(const std::shared_ptr<RegisterMap> &register_map,
