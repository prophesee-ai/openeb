...
class PseeDeviceControl : public I_DeviceControl {
public:
    PseeDeviceControl(EvtFormat fmt);
    ...
    bool set_evt_format(EvtFormat fmt);

    /// @brief Retrieves EVT format
    /// @return event format
    EvtFormat get_evt_format();
...
private:
    ...
    virtual bool set_evt_format_impl(EvtFormat fmt) = 0;
