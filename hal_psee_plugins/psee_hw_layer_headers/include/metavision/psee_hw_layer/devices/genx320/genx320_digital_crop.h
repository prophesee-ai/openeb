...
#ifndef METAVISION_HAL_PSEE_PLUGINS_DEVICES_GENX320_DIGITAL_CROP_H
...
/// @brief Digital Crop GenX320 implementation
/// All pixels outside of the cropping region will be dropped by the sensor
class GenX320DigitalCrop : public I_DigitalCrop {
    RegisterMap::FieldAccess enable_;
    RegisterMap::FieldAccess drop_;
...
public:
    /// @brief GenX320DigitalCrop constructor
    /// @param regmap the Register map for the sensor
    /// @param prefix the prefix path to retrieve registers in the regmap
    GenX320DigitalCrop(const std::shared_ptr<RegisterMap> &regmap, const std::string &prefix);
...
#endif // METAVISION_HAL_PSEE_PLUGINS_DEVICES_GENX320_DIGITAL_CROP_H
