...
#ifndef METAVISION_HAL_GEN41_EVENT_TRAIL_FILTER_MODULE_H
#define METAVISION_HAL_GEN41_EVENT_TRAIL_FILTER_MODULE_H
...
class Gen41EventTrailFilterModule : public I_EventTrailFilterModule {
public:
    Gen41EventTrailFilterModule(const std::shared_ptr<RegisterMap> &regmap, const std::string &sensor_prefix);
...
#endif // METAVISION_HAL_GEN41_EVENT_TRAIL_FILTER_MODULE_H
