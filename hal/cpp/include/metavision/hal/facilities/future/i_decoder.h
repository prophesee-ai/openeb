...
#ifndef METAVISION_HAL_FUTURE_I_DECODER_H
#define METAVISION_HAL_FUTURE_I_DECODER_H
...
public:
    ...
    void decode(const RawData *const raw_data_begin, const RawData *const raw_data_end);
...
#include "detail/i_decoder_impl.h"

#endif // METAVISION_HAL_FUTURE_I_DECODER_H
