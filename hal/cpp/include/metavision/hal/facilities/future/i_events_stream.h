...
#ifndef METAVISION_HAL_FUTURE_I_EVENTS_STREAM_H
#define METAVISION_HAL_FUTURE_I_EVENTS_STREAM_H
...
#include "metavision/hal/utils/future/data_transfer.h"
...
public:
    ...
    virtual SeekStatus seek(timestamp target_ts_us, timestamp &reached_ts_us);
    ...
    virtual IndexStatus get_seek_range(timestamp &event_start_ts_us, timestamp &event_end_ts_us) const;
...
private:
    ...
    std::shared_ptr<I_Decoder> decoder_;
...
#endif // METAVISION_HAL_FUTURE_I_EVENTS_STREAM_H
