...
#ifndef METAVISION_HAL_HAL_LOG_H
#define METAVISION_HAL_HAL_LOG_H
...
#define MV_HAL_LOG_ERROR()
#endif

#include "detail/hal_log_impl.h"

#endif // METAVISION_HAL_HAL_LOG_H
