...
/// @brief Ids of the mouse buttons that can be triggered through the User Interface
enum UIMouseButton {
...
/// @brief Ids of the keyboard events that can be triggered through the User Interface
enum UIKeyEvent {
...
#endif // METAVISION_SDK_UI_EVENT_H
