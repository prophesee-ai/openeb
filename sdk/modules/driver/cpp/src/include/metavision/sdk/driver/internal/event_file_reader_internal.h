...
#ifndef METAVISION_SDK_DRIVER_EVENT_FILE_READER_INTERNAL_H
#define METAVISION_SDK_DRIVER_EVENT_FILE_READER_INTERNAL_H
...
public:
    Private(EventFileReader &reader, const std::string &path);
...
#endif /* METAVISION_SDK_DRIVER_EVENT_FILE_READER_INTERNAL_H */
