...
public:
    ...
    virtual TriggerOut &trigger_out();
    virtual Biases &biases();
    virtual Roi &roi();
    virtual AntiFlickerModule &antiflicker_module();
    virtual ErcModule &erc_module();
    virtual EventTrailFilterModule &event_trail_filter_module();
