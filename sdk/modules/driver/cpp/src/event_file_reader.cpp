...
EventFileReader::Private::Private(EventFileReader &reader, const std::string &path) :
    reader_(reader),
    seeking_(false),
...
const std::string &EventFileReader::Private::get_path() const {
    return path_;
}
...
EventFileReader::EventFileReader(const std::string &path) : pimpl_(new Private(*this, path)) {}

EventFileReader::~EventFileReader() {}

const std::string &EventFileReader::get_path() const {
