...
public:
    Private(HDF5EventFileReader &reader, const std::string &path, bool time_shift) : timeshift_(0), reader_(reader) {
#ifdef HAS_HDF5
...
HDF5EventFileReader::HDF5EventFileReader(const std::string &path, bool time_shift) :
