...
int main(int argc, char *argv[]) {
    ...
    options_desc.add_options()
        ...
        ("output-file,o",   po::value<std::string>(&out_hdf5_file_path), "Path to output file.")
    ;
    // clang-format on
    ...
    if (out_hdf5_file_path.empty()) {
        out_hdf5_file_path = boost::filesystem::extension(in_file_path) != "" ?
