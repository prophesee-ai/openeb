...
#ifndef METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_WRITER_H
#define METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_WRITER_H
...
class HDF5EventFileWriter : public EventFileWriter {
public:
    HDF5EventFileWriter(const std::string &path = std::string(),
                         const std::unordered_map<std::string, std::string> &metadata_map =
                             std::unordered_map<std::string, std::string>());
    ~HDF5EventFileWriter() override;
...
#endif // METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_WRITER_H
