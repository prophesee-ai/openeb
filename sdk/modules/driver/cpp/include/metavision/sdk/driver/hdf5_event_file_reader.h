...
#ifndef METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_READER_H
#define METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_READER_H
...
public:
    HDF5EventFileReader(const std::string &path, bool time_shift = true);
...
#endif // METAVISION_SDK_DRIVER_HDF5_EVENT_FILE_READER_H
