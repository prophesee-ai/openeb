...
#define METAVISION_SDK_STREAM_CAMERA_OFFLINE_RAW_INTERNAL_H
...
public:
    OfflineRawPrivate(const std::filesystem::path &rawfile, const FileConfigHints &hints);
...
#endif // METAVISION_SDK_STREAM_CAMERA_OFFLINE_RAW_INTERNAL_H
