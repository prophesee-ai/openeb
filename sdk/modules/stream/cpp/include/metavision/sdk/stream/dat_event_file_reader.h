...
#ifndef METAVISION_SDK_STREAM_DAT_EVENT_FILE_READER_H
#define METAVISION_SDK_STREAM_DAT_EVENT_FILE_READER_H
...
public:
    DATEventFileReader(const std::filesystem::path &path);
    ~DATEventFileReader();
