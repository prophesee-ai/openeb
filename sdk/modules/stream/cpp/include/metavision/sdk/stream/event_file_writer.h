...
#ifndef METAVISION_SDK_STREAM_EVENT_FILE_WRITER_H
#define METAVISION_SDK_STREAM_EVENT_FILE_WRITER_H
...
public:
    ...
    /// @param path Path to the event based file to write
...
private:
    virtual void open_impl(const std::filesystem::path &path) = 0;
...
#endif /* METAVISION_SDK_STREAM_EVENT_FILE_WRITER_H */
