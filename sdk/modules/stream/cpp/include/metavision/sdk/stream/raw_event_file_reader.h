...
#ifndef METAVISION_SDK_STREAM_RAW_EVENT_FILE_READER_H
#define METAVISION_SDK_STREAM_RAW_EVENT_FILE_READER_H
...
public:
    RAWEventFileReader(Device &device, const std::filesystem::path &path);
    ~RAWEventFileReader();
...
#endif // METAVISION_SDK_STREAM_RAW_EVENT_FILE_READER_H
