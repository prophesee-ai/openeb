...
#ifndef METAVISION_SDK_STREAM_HDF5_EVENT_FILE_WRITER_H
#define METAVISION_SDK_STREAM_HDF5_EVENT_FILE_WRITER_H
...
public:
    HDF5EventFileWriter(const std::filesystem::path &path = std::filesystem::path(),
