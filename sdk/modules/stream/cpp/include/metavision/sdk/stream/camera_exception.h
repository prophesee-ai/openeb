...
#ifndef METAVISION_SDK_STREAM_CAMERA_EXCEPTION_H
#define METAVISION_SDK_STREAM_CAMERA_EXCEPTION_H
...
/// @brief Class for all exceptions thrown by Metavision SDK Stream
///
