...
def generate_video(filename_full, accumulation_time, slow_motion_factor, expected_video_info):
    ...
    cmd = "./metavision_raw_to_video -i \"{}\" -o {} -a {} --fourcc MJPG".format(filename_full, output_video,
                                                                                 accumulation_time)
...
def pytestcase_test_metavision_raw_to_video_non_existing_input_file():
    ...
    cmd = "./metavision_raw_to_video -i {}".format(input_raw_file)
    output, error_code = pytest_tools.run_cmd_setting_mv_log_file(cmd)
...
def pytestcase_test_metavision_raw_to_video_on_gen31_recording_default_args(dataset_dir):
    """
...
def pytestcase_test_metavision_raw_to_video_on_gen4_evt2_recording_default_args(dataset_dir):
    """
    Checks output of metavision_raw_to_video application
    """
...
def pytestcase_test_metavision_raw_to_video_on_gen4_evt3_recording_default_args(dataset_dir):
    """
    Checks output of metavision_raw_to_video application
    """
...
def pytestcase_test_metavision_raw_to_video_on_gen31_recording_slow_motion_2(dataset_dir):
    """
    Checks output of metavision_raw_to_video application
    """
...
def pytestcase_test_metavision_raw_to_video_on_gen4_evt2_recording_slow_motion_0_5_acc_time_200(dataset_dir):
    """
    Checks output of metavision_raw_to_video application
    """
...
def pytestcase_test_metavision_raw_to_video_on_gen4_evt3_recording_slow_motion_3_acc_time_20000(dataset_dir):
    """
    Checks output of metavision_raw_to_video application
    """
